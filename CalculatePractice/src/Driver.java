...
public class Driver 
{
	public static void main( String [ ] args )
	 {
		CalculatePractice newCalc=new CalculatePractice("./src/Equations.txt");//,"./src/Answers.txt");
    	newCalc.readFile();
    	newCalc.writeResults("./src/Answers.txt");
		//newCalc.readFile("./src/Equations.txt","./src/Answers.txt");
    			//"C:\\Users\\Tony\\Desktop\\Answers.txt");
    	//newCalc.writeResults("C:\\Users\\Tony\\Desktop\\Answers.txt");
